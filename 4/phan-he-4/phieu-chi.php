<?php
/**
 * Quản lý phiếu chi bồi thường hoặc chi phí
 * Hỗ trợ 2 loại chi: bồi thường (liên kết YeuCauBoiThuong) và chi phí khác
 */
    ...
    switch ($_POST['action']) {
        case 'create':
            $result = $paymentService->create([
                'ma_yc' => safe($_POST['ma_yc'] ?? ''),
                'ngay_chi' => safe($_POST['ngay_chi']),
        ...
        case 'delete':
            $result = $paymentService->delete(safe($_POST['ma_pc']));
            $message = $result['message'];
            $message_type = $result['success'] ? 'success' : 'error';
            break;
    }
...
// Lấy dữ liệu
$claims = $paymentService->getClaims();
$payments = $paymentService->getList([
    'search' => $_GET['search'] ?? '',
...
$list_phieuchi = $payments['list'];
$tong_chi = $payments['total'];
                            ...
                            <div id="boi_thuong_fields" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <select name="ma_yc" id="ma_yc" onchange="autoFillBT(this)">
                                        ...
                                        <?php foreach ($claims as $yc): ?>
                                        <option value="<?php echo htmlspecialchars($yc['MaYC']); ?>" data-tien="<?php echo htmlspecialchars($yc['SoTienDuyet']); ?>">
                                            <?php echo htmlspecialchars($yc['MaYC']); ?> | <?php echo htmlspecialchars($yc['HoTen']); ?> | <?php echo htmlspecialchars($yc['BienSo']); ?> | <?php echo vnd($yc['SoTienDuyet']); ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
            ...
            <div id="tab-list" class="tab-content">
                ...
                <div class="stat-summary">
                    ...
                    <div class="stat-item">
                        ...
                        <div class="value"><?php echo vnd($tong_chi); ?></div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <?php if (count($list_phieuchi) > 0): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong style="color: #ef4444; font-size: 16px;"><?php echo vnd($pc['SoTien']); ?></strong></td>
                                            <td><?php echo dateVN($pc['NgayChi']); ?></td>
                                            <td>
