...
$ma_pt = $_GET['id'] ?? '';
if (!$ma_pt) {
    die('Không tìm thấy mã phiếu thu!');
}

$phieuThuKho = new PhieuThuKho();
$phieu = $phieuThuKho->thongTinIn($ma_pt);
...
<body>
    ...
    <div class="receipt-container">
        <div class="header">
            ...
            <div>Ngày thu: <?php echo DinhDang::ngay($phieu['NgayThu']); ?></div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value">
                    Từ <?php echo DinhDang::ngay($phieu['NgayLap']); ?> đến <?php echo DinhDang::ngay($phieu['NgayHetHan']); ?>
                </div>
            </div>
        </div>
        ...
        <div class="amount-section">
            ...
            <div class="amount-number">
                Số tiền: <?php echo DinhDang::tien((float) $phieu['SoTien']); ?>
            </div>

            <div class="amount-text">
                Bằng chữ: <strong><?php echo DinhDang::tienBangChu((float) $phieu['SoTien']); ?></strong>
            </div>
        </div>
