...
{
    // Dùng biến để tránh lỗi encoding trong file PHP
    $trangThai = "Hoạt động";

    // Escape bằng mysqli để đảm bảo an toàn và đúng collation
    $trangThai = $this->csdl->escape($trangThai);

    $dieuKien = ["g.TrangThai = '{$trangThai}'"];
    ...
    {
        $dieuKien = ["g.TrangThai = 'Hoạt động' COLLATE utf8mb4_unicode_ci"];
