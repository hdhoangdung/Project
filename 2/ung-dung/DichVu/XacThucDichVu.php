...
// NẠP FILE PHIEN
require_once __DIR__ . '/PhienDichVu.php';
 ...
 *   if (!$xacThuc->daDangNhap()) { header('Location: ' . dirname($_SERVER['SCRIPT_NAME']) . '/dang-nhap.php'); exit; }
   ...
   public function chuyenHuongTheoVaiTro(): void
{
    ...
    header("Location: /Projects/{$phanHe}/index.php");
    exit;
}
