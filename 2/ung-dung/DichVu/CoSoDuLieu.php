    ...
    public function escape(string $str): string
{
    ...
    private function __construct()
    {
        ...
        $this->ketNoi->set_charset("utf8mb4");
$this->ketNoi->query("SET collation_connection = 'utf8mb4_unicode_ci'");
$this->ketNoi->query("SET NAMES 'utf8mb4' COLLATE 'utf8mb4_unicode_ci'");
...
echo $sql;
echo "</pre>";
exit; // để dừng chương trình ngay tại đó
