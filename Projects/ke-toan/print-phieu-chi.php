...
$ma_pc = $_GET['id'] ?? '';
if (!$ma_pc) {
    die('Không tìm thấy mã phiếu chi!');
}

$phieuChiKho = new PhieuChiKho();
$phieu = $phieuChiKho->thongTinIn($ma_pc);
...
<body>
    ...
    <div class="receipt-container">
        <div class="header">
            ...
            <div>Ngày chi: <?php echo DinhDang::ngay($phieu['NgayChi']); ?></div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value"><?php echo DinhDang::ngay($phieu['NgaySuCo']); ?></div>
            </div>
